...
public class TriangleClassifierTest {
	...
	public void identifies_isosceles_triangle() {
		...
		Assert.assertEquals("sides 2 and 3 eaual", "isosceles", classifier.classify(3, 2, 2));
	...
	public void identifies_scalene_triangle() {
		...
		Assert.assertEquals("scalane", type);
	}
	...
	public void identifies_invalid_with_2_equal_sides() {
		...
		Assert.assertEquals("Side 1 nd 3 equal", "invalid", classifier.classify(2, 5, 2));
