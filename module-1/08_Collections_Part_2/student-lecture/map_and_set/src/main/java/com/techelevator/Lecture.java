...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		// Update an item in the map using put (key value)
		...
		// If the key doesn't exist, in the mp, get(key) returns null
		...
		//containsKey(key) returns TRUE if they KEY exists in the Map
		boolean doesCatExist = animalNoises.containsKey("Cat");
		System.out.println("They key, Cat, exists is " + doesCatExist);
		...
		System.out.println();
		/* LOOPING OVER A MAP */
		// Lopp through a map by looping through the Keys
