...
public class Exercises {
	...
	public String animalGroupName(String animalName) {
		...
		animalGroupNames.put("Elepant", "Herd");
	...
	//	int peterMoney;
	//	int paulMoney;
	//	int peterMoneyHalf = (peterMoney / 2);
	//	int newPaulBalance = (paulMoney) + peterMoneyHalf;
		
		// Map<String, Integer> robPeterToPayPaul = new HashMap<String, Integer>();
		// for (String PeterPaul : peterPaul) {
		//if ((peterMoney > 0) && (paulMoney < 10))  {
		//return String PeterPaul, peterMoneyHalf;
		//} 
		//}
		return null;
	 }
