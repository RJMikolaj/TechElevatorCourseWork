...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		String start = out.substring(0, 4);
		String end = out.substring(4);
		return start + word;
	}
	...
	public String nonStart(String a, String b) {
		String aFirstChar = a.substring(1);
		String bFirstChar = b.substring(1);
	...
	public String left2(String str) {
		String rotatedLeft2 = str.substring(2);
		String rotatedLeft2Step2 = str.substring(0, 2);
		return (rotatedLeft2 + rotatedLeft2Step2);
	}
	...
	public String right2(String str) {
		String rotatedRight = (str.substring(str.length()-2));
		return rotatedRight;
	}
	...
	public String withoutEnd2(String str) {
		String withoutFirst = str.substring(0, 1);
		String withoutLast = str.substring(str.length()-1);
	...
	public String middleThree(String str) {
		int stringMiddle = (str.length()/2);
		return str.substring(stringMiddle - 1, stringMiddle + 2);
	}
	...
	public boolean doubleX(String str) {
        ...
        String xString = str.substring(index);
