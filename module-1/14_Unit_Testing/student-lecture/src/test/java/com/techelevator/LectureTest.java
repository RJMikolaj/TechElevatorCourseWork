...
public class LectureTest {
	...
	public void half_of_peters_money_given_to_paul() {
		...
		public void third_of_9_is_3() {
			...
			Assert.assertEquals(3, result, 0); // third argument is number of significance after the decimal
	}
		...
		public void return_our_dog_returns_our_dog() {
			...
			// If not .equals() Override an object, then can build our own assert method
