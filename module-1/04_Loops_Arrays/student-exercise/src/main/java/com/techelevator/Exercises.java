...
public class Exercises {
	 ...
	 */
	// ask how to express this without just adding them
	 ...
	 */
	// Ask Brian about an alternate solution for this one too
	public int[] rotateLeft3(int[] nums) {
		{
			int[] rotated3 = { nums[1], nums[2], nums[0] };
			return rotated3;
		}
	}
	 ...
	 */
	// Ask Brian about an alternate solution for this one as well
